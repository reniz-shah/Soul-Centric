    ...
    <>
      <div className="home">
        ...
        <h4 className="sub-heading">
          Locally grown, sustainably harvested, and delivered fresh to your
          door.
        </h4>

        <h1 className="heading-top-selling-product">
          Our Blockbuster Products
        </h1>
        ...
        <div className="testimonials-container">
          ...
          <p className="text-after-heading">
          ...
          <div className="testimonials-card-container">
            <Card className="yellow-color">
              <Meta
                ...
                description={
                  <TestimonialsDescription description={imageDescription} />
                }
              />
            </Card>
